...
var _cartActions = __webpack_require__(49);

var _booksActions = __webpack_require__(17);
...
var _booksList = __webpack_require__(74);
...
if (_reactRedux.Provider != undefined) {
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(9), __webpack_require__(40)(module)))
...
var _booksReducers = __webpack_require__(47);

var _cartReducers = __webpack_require__(48);
...
function booksReducers() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { books: [{ id: 1,
      title: 'book title!!!!!!!!!!!!!!!!!!1',
      author: 'author name',
      description: 'description of book',
      price: 10 }, { id: 2,
  ...
  switch (action.type) {
    ...
    case 'DELETE_BOOK':
      ...
      var bookListDelete = state.books;
      var indexTodelete = bookListDelete.findIndex(function (book) {
        console.log('book id' + book.id + 'action id', action.payload[0].id);
        return book.id == action.payload[0].id;
      });
      console.log(indexTodelete);
      return { books: [].concat(_toConsumableArray(bookListDelete.slice(0, indexTodelete)), _toConsumableArray(bookListDelete.slice(indexTodelete + 1))) };
      break;
    case 'UPDATE_BOOK':
      //  let books = state.concat(action.payload);
      //return    books;
      ...
      var bookListUpdate = state.books;
      var indexToUpdate = bookListUpdate.findIndex(function (book) {
        console.log('book id' + book.id + 'action id', action.payload[0].id);
        return book.id == action.payload[0].id;
      });
      ...
      return { books: [].concat(_toConsumableArray(bookListUpdate.slice(0, indexToUpdate)), _toConsumableArray(action.payload), _toConsumableArray(bookListUpdate.slice(indexToUpdate + 1))) };
      break;
  }
  return state;
}
...
*/
var aa=__webpack_require__(3),l=__webpack_require__(18),B=__webpack_require__(4),C=__webpack_require__(1),ba=__webpack_require__(19),da=__webpack_require__(20),ea=__webpack_require__(21),fa=__webpack_require__(22),ia=__webpack_require__(23),D=__webpack_require__(6);
